...
RcppExport SEXP _RobustGaSP_const_funct(SEXP dSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter< const MapMat& >::type d(dSEXP);
  rcpp_result_gen = Rcpp::wrap(const_funct(d));
  return rcpp_result_gen;
  END_RCPP
}
...
// pred_rgasp
List pred_rgasp(const Eigen::VectorXd& beta, const double nu, const Eigen::Map<Eigen::MatrixXd>& input, const Eigen::Map<Eigen::MatrixXd>& X, const String zero_mean, const Eigen::Map<Eigen::MatrixXd>& output, const Eigen::Map<Eigen::MatrixXd>& testing_input, const Eigen::Map<Eigen::MatrixXd>& X_testing, const Eigen::Map<Eigen::MatrixXd>& L, Eigen::Map<Eigen::MatrixXd>& LX, Eigen::Map<Eigen::VectorXd>& theta_hat, double sigma2_hat, double q_025, double q_975, List r0, const Eigen::VectorXi& kernel_type, const Eigen::VectorXd& alpha, const String method, const bool interval_data);
...
List generate_predictive_mean_cov(const Eigen::VectorXd& beta, const double nu, const Eigen::Map<Eigen::MatrixXd>& input, const Eigen::Map<Eigen::MatrixXd>& X, const String zero_mean, const Eigen::Map<Eigen::MatrixXd>& output, const Eigen::Map<Eigen::MatrixXd>& testing_input, const Eigen::Map<Eigen::MatrixXd>& X_testing, const Eigen::Map<Eigen::MatrixXd>& L, const Eigen::Map<Eigen::MatrixXd>& LX, const Eigen::Map<Eigen::VectorXd>& theta_hat, double sigma2_hat, List rr0, List r0, const Eigen::VectorXi& kernel_type, const Eigen::VectorXd& alpha, const String method, const bool sample_data);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::MatrixXd>& >::type X_testing(X_testingSEXP);
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::MatrixXd>& >::type L(LSEXP);
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::MatrixXd>& >::type LX(LXSEXP);
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::VectorXd>& >::type theta_hat(theta_hatSEXP);
    Rcpp::traits::input_parameter< double >::type sigma2_hat(sigma2_hatSEXP);
...
// pred_ppgasp
List pred_ppgasp(const Eigen::VectorXd beta, const double nu, const Eigen::Map<Eigen::MatrixXd>& input, const Eigen::Map<Eigen::MatrixXd>& X, const String zero_mean, const Eigen::Map<Eigen::MatrixXd>& output, const Eigen::Map<Eigen::MatrixXd>& testing_input, const Eigen::Map<Eigen::MatrixXd>& X_testing, const Eigen::Map<Eigen::MatrixXd>& L, const Eigen::Map<Eigen::MatrixXd>& LX, const Eigen::Map<Eigen::MatrixXd>& theta_hat, const Eigen::Map<Eigen::VectorXd>& sigma2_hat, double q_025, double q_975, List r0, Eigen::VectorXi kernel_type, const Eigen::VectorXd alpha, const String method, const bool interval_data);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::MatrixXd>& >::type L(LSEXP);
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::MatrixXd>& >::type LX(LXSEXP);
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::MatrixXd>& >::type theta_hat(theta_hatSEXP);
